...
$infoRecibo = getReciboServicio($folio,$connect);
if($infoRecibo){
	...
	$nombreServicio = $recibo['text_concepto'];
	$costoServicio = $recibo['float_monto'];
...
<body>
	...
	<div id="cuerpo">
		...
		<div id="content">
			...
			<div id="service">
				<div class="titl"><img src="../styles/img/detailServ.png" alt="Detalles"></div>
				<div class="lab">Concepto:</div>
				<div class="info-txt"><?php echo($nombreServicio); ?></div>
				<div class="lab"></div>
				<div class="info-txt"></div>
				<div class="lab"></div>
				<div class="info-txt"></div>
			...
			<div id="payment">
				<div class="titl"><img src="../styles/img/detailCobr.png" alt="Cobro actual"></div>
