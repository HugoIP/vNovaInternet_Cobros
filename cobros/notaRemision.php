...
if($infoRecibo){
	...
	$diasPeriodo = dateDiff(date_format($auxDateInit, 'Y-m-d'),date_format($auxDateFin, 'Y-m-d'));
		...
		<div id="content">
			<div id="detallesEmpresa">
				...
				<div id="date">
					...
					<div id="fecha"><?php echo "Fecha: ".$fechaCobro; ?></div>
				</div>
			</div>
			...
			<div id="service">
				...
				<div class="info-txt">hasta <?php echo($velocidadPlan); ?> kbps</div>
			...
			<div id="payment">
				...
				<div class="lab">Costo total de la mensualidad:</div>
				<div class="info-txt" id="moneda">$ <?php echo($totalCobro); ?></div>
				<div class="lab">Cantidad del pago actual:</div>
				<div class="info-txt" id="moneda">$ <?php echo($pago); ?>.00</div>
				<div class="lab">Adeudo restante (pendiente de pago):</div>
				<div class="info-txt" id="moneda">$ <?php echo($saldo); ?>.00</div>
			</div>
			<div id="notice">
				<div class="notice-txt">Este documento es una nota de pago provicional, ya que a&uacute;n se mantiene parte del adeudo</div>
